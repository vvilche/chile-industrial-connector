...
products = [
  ...
  {
    "id": "ln81",
    "name": "Válvula de control neumática de globo de asiento simple serie LN81",
  ...
  # Válvulas de Bola
  {
    ...
    "features": ["Excelente rendimiento de corte y sellado", "Bajo par de operación", "Fuga cero", "Alta resistencia al desgaste"],
    "specifications": {
      "diámetro_nominal": "DN100",
      "presión_máxima": "PN16",
  ...
  {
    "id": "cn81",
    "name": "Válvula de control rotativa excéntrica serie CN81",
    "category": "Válvulas de Bola",
    ...
    "features": ["Estructura de doble excentricidad", "Gran capacidad de flujo", "Alta resistencia a erosión", "Bajo desgaste de asiento"],
    "specifications": {
      "diámetro_nominal": "DN100",
      "presión_máxima": "PN25",
      "fuga_asiento": "Clase VI"
    },
    "certificates": ["CE", "SIL2"],
    "image_path": "images/placeholder.png"
  },
  ...
  # Válvulas de Mariposa
  {
    ...
    "features": ["Libre de fricción y desgaste", "Sellado por par de torsión, cierre hermético a burbujas", "Rendimiento superior bajo altas o bajas temperaturas y presiones"],
    "specifications": {
      "diámetro_nominal": "DN250",
      "presión_máxima": "PN25",
      "fuga_asiento": "Clase VI"
    },
    "certificates": ["CE", "ATEX", "SIL2"],
    "image_path": "images/placeholder.png"
  },
  {
    "id": "bn1101f",
    ...
    "features": ["Resistencia térmica y química", "Corte bidireccional hermético", "Fricción mínima en sellos"],
    "specifications": {
      "diámetro_nominal": "DN150",
      "presión_máxima": "PN16",
      "fuga_asiento": "Cero fugas"
  ...
  # Otros Instrumentos
  {
    ...
    "features": ["Precisión de ±0.05%, máxima de ±0.035%", "Estabilidad a largo plazo de ±0.1% por 10 años", "Soluciones personalizadas para procesos especiales"],
    "specifications": {
      "exactitud": "±0.05 por ciento",
      "estabilidad": "±0.1 por ciento por 10 años",
  ...
  },
  {
    ...
    "features": ["Excelente estabilidad y exactitud", "Comunicación digital HART integrada", "Alta resistencia a sobrepresiones"],
    "specifications": {
      "exactitud": "±0.075 por ciento",
      "estabilidad": "±0.1 por ciento por 5 años",
      "alimentación": "24 VCC"
    },
    "certificates": ["CE", "HART"],
    "image_path": "images/placeholder.png"
  },
  {
    "id": "sfm800",
    "name": "Caudalímetro másico Coriolis SFM800",
    "category": "Otros Instrumentos",
    ...
    "specifications": {
      "tipo": "Caudalímetro másico Coriolis",
      "exactitud": "±0.1 por ciento",
      "aplicación": "Líquidos y gases"
    },
    "certificates": ["CE", "EAC"],
    "image_path": "images/placeholder.png"
  },
  {
    ...
    "specifications": {
      "tipo": "Rotámetro de tubo metálico",
      "exactitud": "±1.5 por ciento",
      "diámetro": "DN15-DN100"
    },
    "certificates": ["CE"],
    "image_path": "images/placeholder.png"
  ...
  {
    "id": "lugb",
    "name": "Medidor de caudal de vórtice (Vortex) LUGB",
    "category": "Otros Instrumentos",
    ...
    "specifications": {
      "tipo": "Caudalímetro de vórtice (Vortex)",
      "exactitud": "±1.0 por ciento",
      "temperatura_máxima": "350 °C"
    },
    "certificates": ["CE", "ATEX"],
    "image_path": "images/placeholder.png"
  },
  {
    "id": "sfe900",
    "name": "Caudalímetro electromagnético inteligente SFE900",
    "category": "Otros Instrumentos",
    ...
    "specifications": {
      ...
      "exactitud": "±0.3 por ciento",
      "conductividad_mínima": "2 μS/cm"
    },
    "certificates": ["CE", "ATEX", "SIL2"],
    "image_path": "images/placeholder.png"
  },
  {
    "id": "emf89",
    "name": "Caudalímetro electromagnético industrial EMF89",
    "category": "Otros Instrumentos",
    ...
    "specifications": {
      "tipo": "Caudalímetro electromagnético",
      "exactitud": "±0.5 por ciento",
      "revestimiento": "PTFE / Neopreno"
    },
    "certificates": ["CE"],
    "image_path": "images/placeholder.png"
  },
  {
    ...
    "specifications": {
      "tipo": "Transmisor de nivel de flotador",
      "exactitud": "±5 mm",
      "salida": "4-20 mA + HART"
    },
    "certificates": ["CE"],
  ...
  },
  {
    ...
    "specifications": {
      "tipo": "Medidor de nivel magnético",
      "exactitud": "±10 mm",
  ...
  {
    "id": "sl80",
    "name": "Transmisor de nivel magnetoestrictivo de precisión SL80",
    "category": "Otros Instrumentos",
    ...
    "specifications": {
      "tipo": "Transmisor de nivel magnetoestrictivo",
      "exactitud": "±1 mm",
      "rango": "0.3 a 6 m"
    },
    "certificates": ["CE", "SIL2"],
  ...
  {
    "id": "sl900",
    "name": "Transmisor de nivel radar FMCW de 80 GHz serie SL900",
    "category": "Otros Instrumentos",
    ...
    "specifications": {
      "tipo": "Transmisor de nivel radar 80 GHz",
      "exactitud": "±2 mm",
      "rango": "Hasta 120 m"
    },
    "certificates": ["CE", "ATEX", "SIL2"],
  ...
  },
  {
    ...
    "specifications": {
      "tipo": "Posicionador inteligente",
      "alimentación": "4-20 mA + HART",
      "acción": "Lineal / Rotativo"
    },
    "certificates": ["CE", "ATEX", "SIL2"],
    "image_path": "images/placeholder.png"
  },
  {
    "id": "x600",
    "name": "Calibrador y comunicador de campo serie X600",
    "category": "Otros Instrumentos",
    ...
    "specifications": {
      "tipo": "Calibrador y comunicador HART",
      "exactitud": "0.01 por ciento",
      "pantalla": "HD 1080P Táctil"
    },
    "certificates": ["CE", "HART"],
    "image_path": "images/placeholder.png"
  },
  {
    ...
    "specifications": {
      "tipo": "Barrera de seguridad aislada",
      "exactitud_conversión": "0.1 por ciento",
      "deriva_térmica": "1 μA/°C"
    },
    "certificates": ["CE", "ATEX", "SIL3"],
    "image_path": "images/placeholder.png"
  },
  {
    ...
    "specifications": {
      "tipo": "Válvula de descarga tipo Y",
      "diámetro": "DN25-DN100",
      "aplicación": "Química y farmacia"
    },
    "certificates": ["CE"],
    "image_path": "images/placeholder.png"
  },
  {
    "id": "pz",
    "name": "Válvula de guillotina para sólidos serie PZ",
    "category": "Otros Instrumentos",
    ...
    "specifications": {
      "tipo": "Válvula de guillotina",
      "diámetro": "DN50-DN600",
      "aplicación": "Minería y pulpa"
    },
    "certificates": ["CE"],
    "image_path": "images/placeholder.png"
  },
  {
    ...
    "specifications": {
      "tipo": "Válvula de compuerta plana",
      "operación": "Eléctrica",
      "aplicación": "Partículas suspendidas"
    },
    "certificates": ["CE"],
    "image_path": "images/placeholder.png"
  },
  {
    ...
    "features": ["Flujo no perturbado de baja caída de presión", "Estructura de sellado hermético a presión de medio", "Bajo par de operación de apertura y cierre"],
    "specifications": {
      "tipo": "Válvula de compuerta de cuña",
      "operación": "Neumática / Eléctrica",
      "aplicación": "Baja caída de presión"
    },
    "certificates": ["CE"],
    "image_path": "images/placeholder.png"
  },
  ...
  # Sistemas de Control
  {
    ...
    "specifications": {
      "tipo": "Sistema de Control Distribuido (DCS)",
      "escala": "Hasta 1,000,000 E/S",
      "red": "Modbus, HART, FF, Profibus"
    },
    "certificates": ["CE", "SIL3", "EAC", "PAC", "G3"],
    "image_path": "images/placeholder.png"
  },
  {
    "id": "jx-300xp",
    ...
    "specifications": {
      "tipo": "Sistema de Control Distribuido (DCS)",
      "red": "SCnet II redundante",
      "diagnóstico": "En línea inteligente"
    },
    "certificates": ["CE", "G3"],
    "image_path": "images/placeholder.png"
  },
  {
    ...
    "specifications": {
      "tipo": "Sistema Instrumentado de Seguridad (SIS)",
      "cobertura_diagnóstico": "> 99 por ciento",
      "arquitectura": "2oo3D de 5 capas"
    },
    "certificates": ["CE", "SIL3", "G3", "EMC 4A"],
    "image_path": "images/placeholder.png"
  },
  {
    "id": "tcs-500",
    ...
    "specifications": {
      "tipo": "Sistema Instrumentado de Seguridad (SIS)",
      "cobertura_diagnóstico": "> 99 por ciento",
      "arquitectura": "2oo4D con degradación"
    },
    "certificates": ["CE", "SIL3", "G3"],
    "image_path": "images/placeholder.png"
  },
  {
    "id": "g5-pro",
    ...
    "specifications": {
      "tipo": "Controlador Lógico Programable (PLC)",
      "CPU": "32 bits a 1 GHz",
      "seguridad": "RSA y AES integrada"
    },
    "certificates": ["CE", "SIL3"],
    "image_path": "images/placeholder.png"
  },
  {
    ...
    "specifications": {
      ...
      "protocolos": "Modbus, Profinet, OPC"
    },
    "certificates": ["CE"],
    "image_path": "images/placeholder.png"
  },
  {
    ...
    "specifications": {
      "tipo": "Sistema de Control Universal (UCS)",
      "arquitectura": "Definida por software en la nube",
      "ventaja": "Sin gabinetes tradicionales"
    },
    "certificates": ["CE"],
    "image_path": "images/placeholder.png"
  }
...
# Write to productos.json
with open("productos.json", "w", encoding="utf-8") as f:
    json.dump(products, f, indent=2, ensure_ascii=False)

# Write to js/productos.js
with open("js/productos.js", "w", encoding="utf-8") as f:
    f.write("const SUPCON_PRODUCTS = " + json.dumps(products, indent=2, ensure_ascii=False) + ";\n")

print(f"Successfully generated productos.json and js/productos.js with {len(products)} real SUPCON products.")
